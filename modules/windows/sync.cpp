...
class messaging_queue_std_t final : public messaging_queue_t
{
...
bool messaging_queue_std_t::post(message_t msg) noexcept
{
...
bool messaging_queue_std_t::peek(message_t& msg) noexcept
{
    std::unique_lock lck{cs};
    return this->try_pop(msg);
}

bool messaging_queue_std_t::wait(message_t& msg, duration timeout) noexcept
{
...
{
    return std::make_unique<messaging_queue_std_t>();
}
